# early symptoms - fatigue , yellow fingers, anxiety, coughing ,shortness of breath,allergy,chronic disease,wheezing
...
m_earlysym <- ulam(                                    # age and shortness of breath
    alist( 
...
m_late <- ulam(                                    # age and shortness of breath
    alist( 
    LUNG_CANCER ~ dbinom( 1 , p ) , 
...
print(compare(m_earlysym,m_late))
