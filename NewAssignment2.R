...
m_sym <- ulam(                                    # age and shortness of breath
    alist( 
    LUNG_CANCER ~ dbinom( 1 , p ) , 
...
m_sym1 <- ulam(                                    # age and shortness of breath
    alist( 
    LUNG_CANCER ~ dbinom( 1 , p ) , 
...
print(compare(m_lifestyle,m_lifestyle1,m_sym,m_sym1))
plot(compare(m_lifestyle,m_lifestyle1,m_sym,m_sym1))