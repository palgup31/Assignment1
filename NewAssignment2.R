...
print("hello2")
print(precis(M_lifestyle,depth = 2))


# m_symptoms1 <- ulam(   # removed age,gender,shortness of breath,
#             alist( 
#               LUNG_CANCER ~ dbinom(1, p),
...
M_symptoms <- ulam(                             # age and shortness of breath
    alist( 
    LUNG_CANCER ~ dbinom( 1 , p ) , 
...
print(compare(M_lifestyle,M_symptoms))
plot(compare(M_lifestyle,M_symptoms))